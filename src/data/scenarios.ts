...
export const scenarios: Scenario[] = [
  ...
  },
  {
    ...
    learningSummary: "Hannibal's campaign offers timeless strategic lessons. First, asymmetric approaches can overcome superior resources - Hannibal's indirect strategy of crossing the Alps exemplifies attacking where enemies least expect. Second, psychological factors often outweigh material ones - his victories created fear in Rome that almost broke their alliance system. Third, tactical brilliance must align with strategic objectives - despite winning battles, Hannibal couldn't translate victories into ending the war.\n\nThe campaign demonstrates the importance of understanding an opponent's center of gravity - Rome's alliance network remained largely intact despite Hannibal's presence. It shows how strategic patience (Fabius' approach) can counter tactical genius, and highlights that war ultimately serves political objectives. Modern leaders can learn that bold, unexpected approaches can overcome resource disadvantages, but must be paired with achievable strategic goals and the ability to convert tactical success into lasting outcomes."
  }
];
